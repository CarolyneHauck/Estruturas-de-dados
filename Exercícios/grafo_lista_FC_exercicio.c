...
int main(){
	...
	insereAresta(1,8,1,grafo);
	insereAresta(2,5,1,grafo);
	insereAresta(3,7,1,grafo);
	insereAresta(3,8,1,grafo);
	insereAresta(4,8,1,grafo);
	insereAresta(5,6,1,grafo);
	insereAresta(6,2,1,grafo);
	insereAresta(7,9,1,grafo);
	insereAresta(8,0,1,grafo);
	insereAresta(9,7,1,grafo);
