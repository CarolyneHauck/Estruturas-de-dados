...
int main(){
	...
	TipoGrafo* grafo2 = (TipoGrafo*) malloc(sizeof(TipoGrafo));
	grafo2->numVertices = 6;
	grafo2->numArestas = 10;
	FGVazio(grafo2);

	insereAresta(0,1,1,grafo2);
	insereAresta(0,4,1,grafo2);
	insereAresta(2,0,1,grafo2);
	insereAresta(2,3,1,grafo2);
	insereAresta(2,4,1,grafo2);
	insereAresta(3,4,1,grafo2);
	insereAresta(3,5,1,grafo2);
	insereAresta(4,1,1,grafo2);
	insereAresta(4,5,1,grafo2);
	insereAresta(5,1,1,grafo2);
	printf("Imprime a lista de adjacencia do grafo dirigido:\n");
	imprimeGrafo(grafo2);

	buscaEmProfundidade(grafo2);

	//Cria outro grafo:
	TipoGrafo* grafo3 = (TipoGrafo*) malloc(sizeof(TipoGrafo));
	grafo3->numVertices = 6;
	grafo3->numArestas = 10;
	FGVazio(grafo3);

	insereAresta(0,2,1,grafo3);
	insereAresta(0,3,1,grafo3);
	insereAresta(0,4,1,grafo3);
	insereAresta(1,2,1,grafo3);
	insereAresta(1,4,1,grafo3);
	insereAresta(2,4,1,grafo3);
	insereAresta(3,4,1,grafo3);
	insereAresta(3,5,1,grafo3);
	insereAresta(4,5,1,grafo3);
	insereAresta(5,1,1,grafo3);
	printf("Imprime a lista de adjacencia do grafo dirigido:\n");
	imprimeGrafo(grafo3);

	buscaEmLargura(grafo3);
