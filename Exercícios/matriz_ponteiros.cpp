/*  Matriz dinâmica representada por vetor de ponteiros:
	cada linha é representada por um vetor independente.
	A matriz é, então, um vetor de ponteiros, onde cada
	elemento armazena o endereço do primeiro elemento de
	cada linha.
...
int main() {
	...
	free(mat); // Libera o vetor coluna
}
